...
main_model.train(data='/workspace/diploma_project/data/server_data.yaml',
                 epochs=100, device='0', imgsz=640, augmentations=custom_transforms, patience=20)

metrics = main_model.val(data='/workspace/diploma_project/data/server_data.yaml', imgsz=640)
