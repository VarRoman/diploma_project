...
\newcommand{\visorFio}{Клятченко Ярослав Михайлович}                 % Рецензент проекту: прізвище, ім’я, по батькові
...
{
структурна та функціональна схеми системи, схема алгоритму роботи трекера.
}
