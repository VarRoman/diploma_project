...
\newcommand{\thesisAuthorTask}{Іванову Івану Івановичу}       % Кому видане завдання для дипломного проектування
...
{\todo{Національний технічний університет України}}
\newcommand{\thesisOOrganization} 
{\todo{«Київський політехнічний інститут імені Ігоря Сікорського»}}

\newcommand{\thesisInstitute}           % Факультет
{\todo{Факультет інформатики та обчислювальної техніки}}

\newcommand{\thesisDepartment}          % Кафедра
{\todo{Кафедра обчислювальної техніки}}
...
{\todo{доктор фіз.-мат. наук, професор}}
...
\rownumber & Вивчення та аналіз завдання  & 12.05.2026--30.05.2026 &  \TBstrut \tabularnewline 
\hline

\rownumber & Розробка архітектури та загальної структури системи  &  &  \TBstrut \tabularnewline 
\hline

\rownumber & Програмна реалізація системи   &  &  \TBstrut \tabularnewline 
\hline

\rownumber & Оформлення пояснювальної записки  &  &  \TBstrut \tabularnewline 
\hline
