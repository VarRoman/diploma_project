...
\newcommand{\completeDate}{05~червня \the\year\ року}  % Дата здачі закінченого проекту
\newcommand{\approvalDate}{03~червня 2026 року}  % Дата затвердення наказом по університету
\newcommand{\approvalNum}{2055-с}   % Номер наказу затвердення теми
...
\newcommand{\visorFio}{Клятченко Ярослав}                 % Рецензент проекту: прізвище, ім’я, по батькові
%{Писаренко Андрій Володимирович}
\newcommand{\visorRegalia}{доц., к.т.н., доцент кафедри СПСКС}             % Рецензент проекту: посада, науковий ступінь, вчене звання
%{кандидат наук, доцент}

\newcommand{\consultantFio}{Міщенко Людмила Дмитрівна}           % Консультант проекту: прізвище, ім’я, по батькові
%{Сімоненко Валерій Павлович}
\newcommand{\consultantRegalia}{док. філос., ас. кафедри ОТ}      % Консультант проекту: посада, науковий ступінь, вчене звання
%{доктор технічних наук, професор}
\newcommand{\consultantInitials}{Міщенко Л. Д.}     % Консультант проекту: прізвище та ініціали
%{Сімоненко~В.~П.}
\newcommand{\consultantPart}{Нормоконтроль}      % Консультант проекту: назва розділу
%{Нормоконтроль}
...
{%
{\raggedright Аналіз теорії та обґрунтування теми. Математичне та алгоритмічне забезпечення аналітичної системи. Програмна реалізація системи. Аналіз результатів та експериментальні дослідження.\par}%
}

%-------- Перелік графічного матеріалу -------------
\newcommand{\graphicMaterial}
{
Схема структурна. Схема функціональна. Схема алгоритму.
}
...
\rownumber & Передзахист  & 01.06.2026-06.06.2026 &  \TBstrut \tabularnewline
\hline

\rownumber & Захист  & 19.06.2026 &  \TBstrut \tabularnewline
\hline
